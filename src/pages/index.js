        ...
        <Layout className='lg:pt-8 md:pt-4 sm:pt-4 pt-0 3xl:p-16 '>
          <div className='flex items-center justify-between w-full md:flex-col'>
            ...
            <div className=' w-1/2 flex flex-col items-center self-center md:w-full md:text-center'>
              ...
              <p className='my-4 text-base font-medium'> I&apos;m a fourth-year college student, a passionate full-stack developer dedicated to bringing ideas to life in the form of innovative web applications.
